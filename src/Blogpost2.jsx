...
function Blogpost2() {
  return (
    <div className="blogpost2-container">
      <Card className="blogpost2-card">
        ...
        <img className="rounded-square" src={Basketball} alt="Basketball" />
        <img className="rounded-square" src={Destiny2} alt="Destiny2" />

  ...
  return (
    <div>
        <Card>
            ...
            <p>I would presume it's something similar to a react website or a webiste using some kind of library or framework</p>
            <h2>List some ideas that without a Framework, would take you a long time to code</h2>
            <p>A simple today list would take a couple hundred lines of css and javascript code.</p>
        </Card>
    </div>
  )
}
